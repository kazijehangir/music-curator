...
11. **Secure CORS**: Always restrict `allow_origins` to specific trusted domains or use a configurable allowlist via environment variables. Do not use `allow_origins=["*"]` with `allow_credentials=True`.
