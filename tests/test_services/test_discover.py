...
def test_run_discovery_skip_invalid_exts(tmp_path, mocker):
    ...
    # Mock get_full_list to be empty to simulate no existing files
...
def test_run_discovery_update_file(tmp_path, mocker):
    ...
    existing_file_path = str(yubal_dir / "existing_song.flac")
    existing_record = mocker.MagicMock(file_path=existing_file_path, file_hash="old_hash", id="rec_123")
