...
class Settings(BaseSettings):
    ...
    # SECURITY: Overly permissive CORS configuration ("*") allows any website to make
    # cross-origin requests. Restricting to specific origins prevents CSRF-like attacks.
