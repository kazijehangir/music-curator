...
def run_discovery(pb: Optional[PocketBase] = None, ingest_folders: Optional[list[str]] = None) -> Dict[str, Any]:
    ...
    # BOLT OPTIMIZATION: Pre-fetch all existing file paths and hashes into memory
    ...
    try:
        ...
        return {"status": "error", "new_files": 0, "updated_files": 0, "errors": [f"Failed to pre-fetch files: {e}"]}
