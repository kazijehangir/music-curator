...
def cleanup_orphaned_releases() -> Dict[str, Any]:
    ...
    # Optimization: Parallelize deletion of orphaned releases to avoid N+1 slow sequential network API calls
    with concurrent.futures.ThreadPoolExecutor(max_workers=10) as executor:
        futures = {executor.submit(_delete_orphan, r_id): r_id for r_id in orphan_ids}
